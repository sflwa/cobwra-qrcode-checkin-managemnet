<?php
/**
 * COBWRA Dashboard - Visual Intelligence & Priority Reporting (v19.4)
 */
	...
	public function render_dashboard() {
		...
		<div class="cobwra-dash">
			...
			<div class="stat-bar">
				...
				<div class="stat-item"><h4>Announced Guests</h4><strong><?php echo $announced_count; ?></strong></div>
			...
			<h3 class="section-label" style="background:#2c3e50;">Verification Priority Log</h3>
			<div style="background:#fff; padding:20px; border:1px solid #ddd;">
				...
				<table class="wp-list-table widefat fixed striped">
					...
					<tbody>
						...
						?>
						<tr style="background:#f9f9f9;"><td colspan="3" style="text-align:center; color:#888;">Note: Matches and <?php echo $public_count; ?> Public scans hidden to condense view.</td></tr>
					</tbody>
				</table>
			</div>
